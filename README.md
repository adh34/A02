...
**Step 1: Install Git** 
Install Git using this link: git-scm.com/downloads. Choose the download for your operating system (Windows, macOS, or Linux). Run the installer, leaving all default settings as they are, and click through to finish. Open your computer's terminal (or Git Bash on Windows) and type git --version. If a version number prints out, the installation was successful.

**Step 2: Set Up Your GitHub Account** 
Go to github.com/signup. Enter your email, create a password, and pick a unique username. Follow the prompts to verify your email address.
...
Log into your new GitHub account. Click the + icon in the upper-right corner and select New repository. Name the repository A02. Set the visibility to Public. Check the box to Add a README file. Click the green Create repository button.
...
**If using VS Code / Terminal:** Open your terminal and use the cd command to navigate to where you want to save the folder (e.g., cd Documents). Type git clone and the URL and hit Enter. This creates an A02 folder on your machine. Open VS Code, click File then Open Folder, and select your new A02 folder. 
**If using WebStorm:** Open WebStorm, click File then New then Project from Version Control. Paste the copied GitHub URL into the URL box, choose your destination folder, and click Clone.

**Step 6: Configure Git Identity & Connect Accounts** 
**In VS Code:** Open the integrated terminal (Terminal then New Terminal) and configure your identity by running: 
git config user.name "Your First and Last Name" 
git config user.email "your.email@example.com" 
**In WebStorm:** Go to Settings (or Preferences on Mac) then Version Control then GitHub. Click the + button to log in via GitHub and authorize the IDE to connect to your account.

**Step 7: Make Changes and Commit** 
Open the README.md file in your IDE's file explorer. Type a brief description of the project into the file and save it (Ctrl+S / Cmd+S). 
...
**In WebStorm:** Go to Git then Push (or press Ctrl+Shift+K), review the changes, and click Push. 
...
* **Repository**: A specific storage directory that holds all of your project's files, folders, and the entire historical timeline of changes tracked by Git.

**PART 3: References**

* Git. (n.d.). gitglossary. Retrieved from https://git-scm.com/docs/gitglossary
* Hendela, A. H. (2019). Introduction to GitHub and WebStorm [PowerPoint slides]. NJIT, IS117.
* Hendela, A. H. (2020). Additional instructions on creating a Git and GitHub repository [PowerPoint slides]. NJIT, IS117.
* JetBrains. (n.d.). Download WebStorm. https://www.jetbrains.com/webstorm/download/
* Microsoft. (2026a). Source control in VS Code. Retrieved from https://code.visualstudio.com/docs/sourcecontrol/overview
* Microsoft. (2026b). Work with GitHub in VS Code. Retrieved from https://code.visualstudio.com/docs/sourcecontrol/github
